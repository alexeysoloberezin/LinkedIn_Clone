...
function NavItem({ icon, label, notifications}: NavItemProps = {}) {
  return (
    <div className='relative flex flex-col items-center w-fit cursor-pointer opacity-75 hover:opacity-100 hover:bg-gray-100 transition-opacity duration-300 ease-in-out py-2 px-4'>
      {notifications ? (
